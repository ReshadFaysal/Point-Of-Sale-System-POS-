...
if(isset($_POST['btn_login'])){
  ...
  else if($row['username']==$username AND $row['password']==$password AND $row['role']=="Sales Representative"){
...
<body>
 ...
 <div id="login">
        <h3 class="text-center text-white pt-5"> <b>Point of Sell |</b> System</h3>
        <hr>
        <div class="container">
