...
<div class="container">
  <div class="row">
    <div class="column">
      ...
      <span class="icon"><i class="fa fa-level-down fa-5x"></i></span><h4>Limited Stock</h4>
        ...
        <?php
          ...
          <?php if($total1==true){ ?>
                <span class="stock-info-number"><strong><?php echo $tol;?></small></span>
                <?php }else{?>
    ...
    <div class="column">
      <div class="card">
      <span class="icon"><i class="fa fa-truck fa-5x"></i></span> <h4>Reserved Products</h4>
    ...
    <div class="column">
      <div class="card">
      <span class="icon"><i class="fa fa-shopping-cart fa-5x"></i></span><h4>Daily Transction</h4>
    ...
    <div class="column">
      <div class="card">
      <span class="icon"><i class="fa fa-line-chart fa-5x"></i></span> <h4>Sold Amount</h4>
